...
/**
 * **plugin-number-line-task**
 *
 * This will be a plugin to create the Cohen-Ray Number Line.
 *
 * @author jsPsychHackathon 2025
 * @see {@link https://github.com/jspsych/jspsych-contrib/packages/plugin-number-line-task/README.md}}
 */
class NumberLineTaskPlugin implements JsPsychPlugin<Info> {
  static info = info;
...
export default NumberLineTaskPlugin;
